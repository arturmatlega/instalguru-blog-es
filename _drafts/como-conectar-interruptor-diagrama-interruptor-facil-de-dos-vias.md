...
intro: Un interruptor de luz es un modesto dispositivo gracias al cual la vida cotidiana
  en la casa se hace mucho más fácil. Mientras que los interiores estándar usan interruptores
  singulares, lugares como las escaleras pueden ser más complicados. Para ello, se
  necesita un circuito especial de interruptor de dos vías, que permite controlar
  la luz desde dos puntos. ¿Cómo conectar un interruptor de dos vías? No es tan difícil
  - sólo eche un vistazo a un diagrama de interruptor de dos vías y úselo en su propio
  lugar.
photo: "/uploads/wlacznik-schodowe-glowne.jpg"
photo_desc: Un simple diagrama de conmutación de dos vías
faq: []
