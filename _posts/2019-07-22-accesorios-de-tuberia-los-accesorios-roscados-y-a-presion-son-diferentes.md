...
- question: 'Accesorios PEX: ¿cómo instalarlos?'
  answer: El método de instalación de los accesorios de tubería PEX depende de su
    construcción. Antes de comenzar el proceso de instalación debe asegurarse de qué
    tipo posee y seguir las instrucciones del fabricante.
- question: "¿Cómo medir los accesorios de las tuberías?"
  answer: La medición de las tuberías y accesorios de las tuberías depende del tipo
    de hilo. Para las roscas macho, medir el diámetro exterior. Para las roscas hembra,
    debe medir el diámetro interior.
- question: "¿Cómo se sudan los accesorios de cobre?"
  answer: Empieza por limpiar el metal y aplica una pasta de fundir. Ponga el accesorio
    de la tubería en el tubo y caliente la unión para que la pasta de fundir se derrita
    y asegure el accesorio.
- question: "¿Cómo quitar los accesorios de pex?"
  answer: La forma más fácil de quitar los accesorios de la tubería PEX es usando
    una herramienta especial de extracción. Úsela para cortar la banda del anillo
    de engarce. Muchos tipos, por ejemplo los accesorios de cobre, pueden ser usados
    de nuevo, si no están dañados.
