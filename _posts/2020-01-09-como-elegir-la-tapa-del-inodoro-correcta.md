...
- question: "¿Cómo se mide el asiento del inodoro?"
  answer: Las cualidades que hay que medir son el ancho y el largo de la taza del
    inodoro, y el ancho de las bisagras. Asegúrate de tomar las medidas con mucho
    cuidado. Un asiento de inodoro demasiado ancho o estrecho no encajaría en el inodoro.
- question: "¿Cómo se reemplaza el asiento del inodoro?"
  answer: Empieza por quitar el viejo asiento del inodoro. Si el asiento se usó durante
    mucho tiempo, los tornillos podrían ser difíciles de quitar. En tal caso, use
    un producto especial, por ejemplo el WD-40. Después de quitar el asiento viejo,
    proceda a instalar el nuevo.
- question: "¿Cómo se instala un asiento de inodoro?"
  answer: Es mejor seguir las instrucciones del fabricante. La instalación suele consistir
    en colocar barras especiales en lugares adecuados, sellarlas y fijarlas al inodoro.
    Tenga cuidado de no dañar el inodoro al instalar el asiento del inodoro.
- question: "¿Cómo se usan las fundas de los asientos de los inodoros?"
  answer: Saque la tapa de su contenedor y espárzala sobre el asiento del inodoro.
    Pellizque la sección media para que caiga en la taza del inodoro. Después de usar
    el inodoro puede tirar la tapa ya que está hecha de material desechable.
